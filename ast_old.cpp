...
void ast_old::build_tree(exec_node* cst_head, symbol_table table){
...
exec_node* ast_old::shunting_yard_wrapper(exec_node* cst_head, ast_node* prev){
...
ast_node* ast_old::shunting_yard(std::vector<exec_node*> tokens, ast_node* first){
...
void ast_old::add_node(ast_node* n){
